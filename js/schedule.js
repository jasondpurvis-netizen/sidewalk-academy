...
async function schLogbook(v){
  ...
  h+=`<div class="card" style="padding:16px;margin-top:14px"><div style="font-size:15.5px;font-weight:600;letter-spacing:-.012em;text-transform:none;color:var(--ink);margin-bottom:11px">What does the next leader need to know?</div><textarea id="logSummary" placeholder="What does the next leader need to know?" style="width:100%;min-height:70px;padding:11px;border:1px solid var(--line2);border-radius:8px;font-size:14px;font-family:inherit;color:var(--ink);background:var(--card)">${esc(meta.summary||'')}</textarea><div class="row" style="margin-top:9px"><button class="btn pri" style="width:auto;margin-left:auto" onclick="logSaveMeta('${d0}')">Save the day</button><span id="logmsg" class="muted" style="font-size:14px;align-self:center;margin-left:8px"></span></div></div>`;
