...
window._tourShow=function(){
  ...
  var box='<div style="position:fixed;z-index:10000;width:'+bw+'px;max-width:92vw;background:var(--card);border-radius:14px;box-shadow:0 16px 48px rgba(0,0,0,.34);padding:17px 19px;top:'+boxTop+'px;left:'+boxLeft+'px"><div style="font-weight:800;font-size:15px;color:var(--ink)">'+s.title+'</div><div class="faint" style="font-size:13px;margin-top:7px;line-height:1.55">'+s.text+'</div><div style="display:flex;justify-content:space-between;align-items:center;margin-top:15px"><span class="faint" style="font-size:12px">'+(window._tourI+1)+' of '+st.length+'</span><div style="display:flex;gap:7px"><button class="btn" style="width:auto;padding:6px 11px;font-size:12.5px" onclick="window._tourEnd()">Skip tour</button>'+(window._tourI>0?'<button class="btn" style="width:auto;padding:6px 11px;font-size:12.5px" onclick="window._tourNav(-1)">Back</button>':'')+'<button class="btn pri" style="width:auto;padding:6px 13px;font-size:12.5px" onclick="'+(last?'window._tourEnd()':'window._tourNav(1)')+'">'+(last?'Got it':'Next')+'</button></div></div></div>';
