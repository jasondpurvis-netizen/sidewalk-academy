...
async function vSettings(v){
  ...
  const _sx=`<!--SEC:shop--><div class="card" style="padding:22px;max-width:480px">
    <div style="margin-bottom:18px"><label style="display:block;font-size:14px;font-weight:600;margin-bottom:6px">Academy name</label><input id="setname" type="text" value="${esc(s.academy_name||'')}" style="width:100%"/></div>
