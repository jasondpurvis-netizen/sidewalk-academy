...
window._ssRender=function(){
  ...
  var h='<div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px">'
    +'<div><div class="muted" style="font-size:15px;font-weight:600;letter-spacing:-.012em;text-transform:none">Station '+(i+1)+' of '+stations.length+'</div>'
...
window._asRender=function(){
  ...
  h+='<div style="overflow-x:auto;margin-top:14px"><table style="width:100%;border-collapse:collapse;min-width:640px">'
    +'<thead><tr><th style="text-align:left;padding:6px 8px;font-size:11px;font-weight:640;letter-spacing:.06em;text-transform:uppercase;color:var(--muted);position:sticky;left:0;background:var(--card,#fff)">Person</th>'
    + SHORT.map(d=>'<th style="padding:6px 4px;font-size:11.5px;font-weight:620;letter-spacing:.01em;text-transform:none;color:var(--muted)">'+d+'</th>').join('')
    +'<th style="padding:6px 8px;font-size:11.5px;font-weight:620;letter-spacing:.01em;text-transform:none;color:var(--muted);white-space:nowrap">Quick set</th></tr></thead><tbody>';
  people.forEach(function(n){
