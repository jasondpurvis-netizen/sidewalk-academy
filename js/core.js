...
function renderApp(){
  ...
  const NAV_ALL=[["",[["today","Today","ti-sun"],["logbook","Log","ti-clipboard-check"]]],["Academy",[["home","Academy","ti-school"],["build","Build","ti-tools"],["ask","Ask","ti-bulb"],["journal","Journal","ti-notebook"]]],["Every day",[["schedule","Schedule","ti-calendar-week"],["team","Team","ti-users"],["ownership","Who owns what","ti-sitemap"],["onboarding","New Hires","ti-user-plus"],["calendar","Calendar","ti-calendar-month"]]],["Lists",[["rm","Fix-it list","ti-tool"],["recovery","Recovery","ti-heart-handshake"],["lists","Lists","ti-list-details"]]],["Numbers",[["sales","Sales","ti-chart-line"]]],["Shared",[["community","Community","ti-messages"],["resources","Resources","ti-files"],["downloads","Downloads","ti-download"]]],["",[["brain","The Brain","ti-bulb"],["setup","Getting started","ti-list-check"],["settings","Settings","ti-settings"]]]];
